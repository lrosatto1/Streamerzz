            ...
            <div className="max-w-7xl mx-auto px-4 mt-20">
                ...
                >
                    {KEY_FEATURES_CONTENT.features.map((feature) => (
                        <motion.div 
                            key={feature.id} 
                            className="flex flex-col items-center text-center w-full sm:w-1/2 lg:w-1/3 p-6"  // Cambié lg:w-1/4 a lg:w-1/3
                            variants={keyFeatureVariants}
                        >
